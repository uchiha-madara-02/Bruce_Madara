...
const uint8_t IOS1[] = {0x02, 0x0e, 0x0a, 0x0f, 0x13, 0x14, 0x03, 0x0b, 0x0c, 0x11, 0x10, 0x05,
                        0x06, 0x09, 0x17, 0x12, 0x16, 0x15, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e,
...
const uint8_t IOS2[] = {0x01, 0x06, 0x20, 0x2b, 0xc0, 0x0d, 0x13, 0x27, 0x0b, 0x09, 0x02, 0x1e, 0x24,
                        0x2d, 0x2f, 0x01, 0x06, 0x20, 0xc0, 0x0d, 0x13, 0x27, 0x0b, 0x09, 0x02, 0x1e,
                        0x24, 0x2d, 0x2f, 0x01, 0x06, 0x20, 0xc0, 0x0d, 0x13, 0x27, 0x0b, 0x09, 0x02,
                        0x1e, 0x24, 0x2d, 0x2f, 0x01, 0x06, 0x20, 0xc0, 0x0d, 0x13, 0x27, 0x0b, 0x09,
                        0x02, 0x1e, 0x24, 0x2d, 0x2f, 0x01, 0x06, 0x20, 0xc0, 0x0d, 0x13, 0x27, 0x0b,
                        0x09, 0x02, 0x1e, 0x24, 0x2d, 0x2f, 0x01, 0x06, 0x20, 0xc0, 0x0d, 0x13, 0x27,
                        0x0b, 0x09, 0x02, 0x1e, 0x24, 0x2d, 0x2f, 0x01, 0x06, 0x20, 0xc0, 0x0d, 0x13,
                        0x27, 0x0b, 0x09, 0x02, 0x1e, 0x24, 0x2d, 0x2f, 0x01, 0x06, 0x20, 0xc0, 0x0d,
                        0x13, 0x27, 0x0b, 0x09, 0x02, 0x1e, 0x24, 0x2d, 0x2f, 0x01, 0x06, 0x20, 0xc0};
...
const DeviceType android_models[] = {
    ...
    {0x000101}, {0x000102}, {0x000103}, {0x000104}, {0x000105}, {0x000106}, {0x000107}, {0x000108},
    {0x000109}, {0x00010A}, {0x00010B}, {0x00010C}, {0x00010D}, {0x00010E}, {0x00010F}, {0x000110},
    {0x000111}, {0x000112}, {0x000113}, {0x000114}, {0x000115}, {0x000116}, {0x000117}, {0x000118},
    {0x000119}, {0x00011A}, {0x00011B}, {0x00011C}, {0x00011D}, {0x00011E}, {0x00011F}, {0x000120},
    {0x000121}, {0x000122}, {0x000123}, {0x000124}, {0x000125}, {0x000126}, {0x000127}, {0x000128},
    {0x000129}, {0x00012A}, {0x00012B}, {0x00012C}, {0x00012D}, {0x00012E}, {0x00012F}, {0x000130},
    {0x000131}, {0x000132}, {0x000133}, {0x000134}, {0x000135}, {0x000136}, {0x000137}, {0x000138},
    {0x000139}, {0x00013A}, {0x00013B}, {0x00013C}, {0x00013D}, {0x00013E}, {0x00013F}
};
...
const WatchModel watch_models[] = {{0x1A}, {0x01}, {0x02}, {0x03}, {0x04}, {0x05}, {0x06}, {0x07},
                                   ...
                                   {0x1E}, {0x20}, {0x21}, {0x22}, {0x23}, {0x24}, {0x25}};
